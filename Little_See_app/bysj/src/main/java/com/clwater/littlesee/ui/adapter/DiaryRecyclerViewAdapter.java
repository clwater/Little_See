...
public class DiaryRecyclerViewAdapter extends RecyclerView.Adapter<DiaryRecyclerViewAdapter.NormalTextViewHolder> {
    private final LayoutInflater mLayoutInflater;
    private final Context context;
    List<DiaryBean.DateBean> list = new ArrayList<DiaryBean.DateBean>();

    public DiaryRecyclerViewAdapter(Context context , List<DiaryBean.DateBean> _list) {
        this.list = _list;
